...
const int SD_chipSelect = 53;      // chipKit Uno32/uC32: 44 - chipKit Max32: 53
const int FLASH_chipSelect = 8;    // chipKit Uno32/uC32: 8  - chipKit Max32: 8
...
void setup()
{
  ...
  Serial.println("SPIflash Dumpfile Restore");
  Serial.println("-------------------------");
  Serial.println();
