...
const int SD_chipSelect = 53;      // Arduino Mega: 53 - Arduino Due: 53
const int FLASH_chipSelect = 52;   // Arduino Mega: 45 - Arduino Due: 52
...
{
  Serial.begin(115200);
  Serial.println("SPIflash Backup");
  Serial.println("---------------");
  Serial.println();
...
void loop()
{
  ...
  if (dataFile)
  {
    ...
    if (backupType == 'E')
      dataFile.println("// SPIflash raw image dump");
    else
      dataFile.println("// SPIflash filesystem image dump");
    dataFile.println("//");
